                                ...
                                <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                    ...
                                    <div className="grid grid-cols-2 p-2 mt-6 gap-5">
                                        <div className="flex gap-2 text-gray-500 items-center">
                                            <div className={`border-gray-500 rounded-full border-[1px] w-4 h-4`}></div>
                                            Status
                                        </div>
                                        ...
                                        <div className="flex gap-2 font-bold items-center">
                                            High <Add className="rotate-45 cursor-pointer" size="22" color="#697689" />
                                        </div>
                                    </div>
                                    <div className="flex flex-col text-gray-500 p-2 mt-6">
                                        ...
                                        <div className="lex p-2  border-[1px] border-solid border-gray-100 rounded-md text-black mt-4">
                                            This task involves setting up the project environment and configuring all
                                            necessary tools and frameworks to ensure smooth development. The steps
                                            include: Repository Setup Environment Setup Dependency Installation
                                            Configuration Management Database Setup Version Control Integration Testing
